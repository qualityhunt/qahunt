                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="{{ route('admin.gallery.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            <div class="file-loading">
                                                <input id="file-1" type="file" name="gallery_images[]" multiple class="file" data-overwrite-initial="false" data-min-file-count="0">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box-footer">
                                ...
                                <a type="button" class="btn btn-warning" href="{{   route('admin.gallery.index')   }}">{{ trans('backend.back') }}</a>
                            </div>
                        </form>
