                                ...
                                <div class="col-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            ...
                                            <input
                                                value="@if (old('video_url')){{ old('video_url') }}@else{{ $gallery->video_url }}@endif"
                                                type="text" class="form-control" id="video_url" name="video_url">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            ...
                                            <select id="single-selection" name="type">
                                                <option @if ($gallery->type === 0 ) selected @endif value="0">
                                                    {{ trans('backend.video') }} </option>
                                                <option @if ($gallery->type === 1 ) selected @endif value="1">
                                                    {{ trans('backend.image') }} </option>
                                                <option @if ($gallery->type === 2 ) selected @endif value="2">
                                                    {{ trans('backend.both') }} </option>
                                            </select>
