...
<form role="form" action="{{ route('admin.setting.UpdateSiteInfo') }}" method="post"
                    ...
                    <div class="row clealfix">
                       ...
                       <div class="col-sm-12">
                            <div class="card">
                                <div class="header">
                                    <h2>{{ trans('backend.site_title') }} </h2>
                                </div>
                                <div class="body">
...
<div class="row clealfix">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="header">
                <h2>{{ trans('backend.site_meta_description') }}  </h2>
            </div>
            <div class="body">
...
<div class="row clealfix">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="header">
                <h2>{{ trans('backend.site_meta_keywords') }}  </h2>
            </div>
            <div class="body">
...
<div class="row clealfix">
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="header">
                <h2>{{ trans('backend.copy_right') }}  </h2>
            </div>
            <div class="body">
...
<div class="row clealfix">
    ...
    <div class=" col-sm-12">
        <div class="card">
            <div class="header">
                <h2>{{ trans('backend.site_address') }}  </h2>
            </div>
            <div class="body">
