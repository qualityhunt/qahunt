        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                    <h4>Başkanlarımız </h4>
                        <a href="{{   route('admin.team.create')   }}" class="btn btn-primary mb-2 float-right"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href=""
                                                onclick="if(confirm('Silmek İstediğinize Emin Misiniz?')){event.preventDefault();document.getElementById('delete-form-{{ $team->id }}').submit();}else{event.preventDefault();}">
