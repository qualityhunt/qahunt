            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{   route('admin.advert.create')   }}"  class="btn btn-primary mb-2"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      {{$adver->category}}
                                        ...
                                        <td>
                                            <a href="{{   route('admin.advert.edit',$adver->id) }}"> <i
                                                    class="feather icon-edit font-medium-5"></i> </a>
                                            <a href=""
                                                onclick="if(confirm('Silmek İstediğinize Emin Misiniz?')){event.preventDefault();document.getElementById('delete-form-{{ $adver->id }}').submit();}else{event.preventDefault();}">
                                                <i class="feather icon-trash  font-medium-5"> </i></a>
                                            <form id="delete-form-{{ $adver->id }}" method="post"
                                                action="{{ route('admin.advert.destroy',$adver->id) }}">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                                            </form>
