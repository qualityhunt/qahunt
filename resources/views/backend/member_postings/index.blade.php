            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a href="{{   route('admin.member_postings.create')   }}" class="btn btn-primary mb-2"><i
                            ...
                            <table class="table add-rows">
                                ...
                                <tbody>
                                    ...
                                    <td>{{ $loop->index + 1 }}</td>
                                        ...
                                        <td class='name'>{{ $mem->name_tr }}</td>
                                        <td class='location'>{{ $mem->location }}</td>
                                     <td>
                                        <a href="{{route('admin.member_postings.edit',$mem->id) }}"> <i class="feather icon-edit font-medium-5"></i> </a>
                                        <a href=""
                                                onclick="if(confirm('Silmek İstediğinize Emin Misiniz?')){event.preventDefault();document.getElementById('delete-form-{{ $mem->id }}').submit();}else{event.preventDefault();}">
