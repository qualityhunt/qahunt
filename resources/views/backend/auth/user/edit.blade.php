            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                            ...
                            <a class="mr-2 my-15" href="#">
                                <div class="form-group">
                                    <input type="file" class="dropify"
                                        ...
                                        data-allowed-file-extensions="png jpg jpeg" name="profile_image">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="controls">
                                    <label>{{ trans('backend.full_name') }} </label>
                                    <input type="text" name="full_name_tr" class="form-control"
                                        placeholder="{{ trans('backend.full_name') }}" value="{{ $user->full_name_tr}}"
                            ...
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <input type="text" name="phone" class="form-control"
                                        placeholder="{{ trans('backend.phone') }}" value="{{ $user->phone}}" required
                            ...
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <input type="text" name="blood_group" class="form-control"
                                        placeholder="Kan Grubu" value="{{ $user-> blood_group}}" required
                                        data-validation-required-message=" Blood Group field is required">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <input type="text" name="email" class="form-control"
                                        placeholder="{{ trans('backend.email') }}" value="{{ $user->email}}" required
                                        data-validation-required-message="This username field is required">
                                </div>
                            </div>
                ...
                <div class="tab-pane" id="information" aria-labelledby="information-tab" role="tabpanel">
                    ...
                    <div class="row mt-1">
                        ...
                        <h5 class="mb-1"><i class="feather icon-user mr-25"></i>{{ trans('backend.company_info') }}</h5>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input type="text" name="sicil_no" class="form-control"
                                            placeholder="{{ trans('frontend.sicil_no') }}" value="{{ $user->sicil_no}}"
                                            required
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sectors[]" class="select2 form-control" multiple="multiple">
                                        ...
                                        <option value="{{ $sector->id }}" @foreach ($user->sectors as $usersec)
                        ...
                        <div class="form-group">
                            <div class="controls">
                                ...
                                <input name="year_founded" type="text" class="form-control"
                                    value="{{ $user->year_founded}}" placeholder="{{ trans('backend.year_founded') }}"
                        ...
                        <div class="form-group">
                            <div class="controls">
                                ...
                                <input name="agency" type="text" class="form-control" value="{{ $user->agency}}"
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="controls">
                                ...
                                <input type="text" name="main_product" class="form-control"
                                    value="{{ $user->main_product}}" placeholder="{{ trans('backend.main_product') }}"
                        ...
                        <div class="form-group">
                            <div class="controls">
                                <label>{{ trans('backend.brief_description') }} [ {{trans('backend.english') }}
                                    ]</label>
                    ...
                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                        <button type="submit"
                            class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">{{ trans('backend.save') }}
                        </button>
                        <button type="reset" class="btn btn-outline-warning">{{ trans('frontend.reset') }}</button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="input-group mb-75">
                            ...
                            <input name="linkedin_url" type="text" class="form-control" value="{{ $user->linkedin_url}}"
                    ...
                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                        <button type="submit"
                            class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">{{ trans('backend.save') }}</button>
                        <button type="reset" class="btn btn-outline-warning">{{ trans('frontend.reset') }}</button>
                    </div>
                </div>
                {{ html()->closeModelForm() }}
