                            ...
                            <div class="col-12 col-sm-4">
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input readonly type="text" name="blood_group" class="form-control"
                                            placeholder="Kan Grubu" value="{{ $user->blood_group}}"
                                            required data-validation-required-message="This Blood Froup field is required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="controls">
