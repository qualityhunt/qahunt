        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <h4>Ürünler </h4>
                        <a href="{{   route('admin.shopping.create')   }}" class="btn btn-primary mb-2 float-right"><i class="feather icon-plus"></i>&nbsp;
                            {{ trans('backend.new') }}
                        </a>
                        <div class="table-responsive">
                            <table class="table add-rows">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left"> <img style="height: 50px;width: 50px;" class="img-circle" src="{{  URL::to('uploads/shopping/')}}/{{ $shop->image }}"></td>
                                        <td>{{ $shop->name }}</td>
                                        <td>{!! Str::limit($shop->description) !!}</td>
