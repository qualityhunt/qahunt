                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="submit-btn">
                                            ...
                                            setTimeout(reload, 5000);" class="readon">Gönder</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="row row-cols-1 row-cols-md-4 g-3">
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <!-- <div class="card-footer"> <button type="button" class="btn btn-lg">Devamını
                        Görüntüle <i class="fa fa-arrow-right" aria-hidden="true"></i> </i> </button>
                        </div>-->
                    </div>
                </div>
